...
BOOL xMBMasterPortSerialInit(UCHAR ucPORT, ULONG ulBaudRate, UCHAR ucDataBits,
	...
	if (ucPORT == 1) {
		...
		serial = &huart1;
		MODBUS_DEBUG("Slave using usart1!\r\n");
#endif
	} else if (ucPORT == 2) {
#if defined(USING_UART2)
		extern USART_HandleTypeDef huart2;
		serial = &huart2;
		MODBUS_DEBUG("Master using usart2!\r\n");
		...
		serial = &huart3;
		MODBUS_DEBUG("Master using usart3!\r\n");
		...
		serial = &huart4;
		MODBUS_DEBUG("Master using uart4!\r\n");
		...
		serial = &huart5;
		MODBUS_DEBUG("Master using uart5!\r\n");
		
#endif
	} else if (ucPORT == 6) {
#if defined(USING_UART6)
		extern USART_HandleTypeDef huart6;
		serial = &huart4;
		MODBUS_DEBUG("Master using usart6!\r\n");
